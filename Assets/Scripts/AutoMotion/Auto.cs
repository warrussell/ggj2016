...
public static class Auto
{
	...
	public static IEnumerator MoveAnchorTo(this RectTransform transform, Vector2 target, float duration)
	{
        return MoveAnchorTo(transform, target, duration, Ease.Linear);
	}
    public static IEnumerator MoveAnchorTo(this RectTransform transform, Vector2 target, float duration, EaseType ease)
	{
        return MoveAnchorTo(transform, target, duration, Ease.FromType(ease));
	}
    
    public static IEnumerator MoveAnchorTo(this RectTransform transform, Vector2 target, float duration, Easer ease)
    {
        float elapsed = 0;
        ...
        {
            elapsed = Mathf.MoveTowards(elapsed, duration, Time.deltaTime);
            transform.anchoredPosition = start + range * ease(elapsed / duration);
            yield return 0;
        }
